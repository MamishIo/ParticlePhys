...
val PARTICLE_RADIUS_RANGE = DoubleRange(12.0, 20.0)
val PARTICLE_HUE_RANGE = FloatRange(0f, 1f)
val PARTICLE_START_VELOCITY_RANGE = DoubleRange(80.0, 120.0)
val PARTICLE_LIFETIME_RANGE = DoubleRange(3.5, 4.5)

val GLOBAL_GRAVITY = Vector2D(0.0, 20.0)

val PARTICLE_SPAWN_RATE = DoubleRange(40.0, 50.0) //DoubleRange(25.0, 40.0)
...
const val QUADTREE_MAX_PARTICLES_PER_LEAF = 5
